function [output,frequency_parameters,notes,spike_triggers,varargout] = readIntanRHD(fn,varargin)
...
% CDE 12 Sep 2022 - I've added compressed command-line output. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% INPUTS:
